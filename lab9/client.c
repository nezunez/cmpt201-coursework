...
- The client reads data from standard input (STDIN_FILENO) in while loop

4. How does the client program end? How can you tell that in the code?
- It ends when there is no more data to read from standard input
- The while loop terminates and the program calls close and exit
*/
